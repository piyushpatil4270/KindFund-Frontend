...
const CampaignDetailPage = () => {
  ...
  const getMyCampaigns = async () => {
    try {
      const res = await axios.get(`https://charity-vercel.vercel.app/campaigns/${campaignId}`,{headers:{"Authorization":userToken}});
  ...
  const deactivateCampaign=async()=>{
    try {
       const res=await axios.post(`https://charity-vercel.vercel.app/campaigns/deactivate/${campaignId}`,{},{headers:{"Authorization":userToken}})
       alert(res.data)
       setTrigger(!trigger)
    } catch (error) {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.post('https://charity-vercel.vercel.app/campaigns/addUpdate', {
